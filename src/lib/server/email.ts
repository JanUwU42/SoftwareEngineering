...
function createTransporter() {
	...
	if (!host || !user || !pass) {
		console.warn('SMTP not configured. Emails will be simulated.');
		return null;
	}
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #ffffff; padding: 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="${resetLink}" style="display: inline-block; background: #1e293b; color: white; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: 600;">
        ...
        <p style="margin: 0; color: #94a3b8; font-size: 12px; text-align: center;">
            Mit freundlichen Grüßen,<br>Ihr Smart Builders Team
        </p>
    </div>
