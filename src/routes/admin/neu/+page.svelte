			...
			<div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
				<div>
					...
					<p class="mt-1 text-sm text-gray-500">
						Erfassen Sie alle Projektdaten und planen Sie die Arbeitsschritte
					</p>
				</div>
				<a
	...
	<main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
		...
		>
					...
					<div>
						...
						<div class="mt-1 flex items-center gap-2">
							<input
								...
								readonly
								class="block w-full cursor-not-allowed rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-gray-600 shadow-sm"
							/>
							<span
			...
			<div class="rounded-xl bg-white p-6 shadow-md">
				<div class="mb-6 flex items-center justify-between">
					<div>
						...
						<p class="mt-1 text-sm text-gray-500">
							Planen Sie die einzelnen Arbeitsschritte für die Zeitstrahl-Ansicht
						</p>
					</div>
					<button
						type="button"
						...
						{#each schritte as schritt, index (index)}
							<div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
								...
								<div class="grid gap-4 sm:grid-cols-2">
									...
									<div class="sm:col-span-2">
										<label
											for="schritt_beschreibung_{index}"
											class="block text-sm font-medium text-gray-700"
										>
											Beschreibung
										</label>
			...
			<div class="flex justify-end gap-4">
				<a
					href="/admin/uebersicht"
					class="rounded-lg border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
				>
					Abbrechen
				</a>
				<button
					type="submit"
					disabled={loading}
					class="inline-flex items-center rounded-lg bg-blue-600 px-6 py-3 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
				>
					{#if loading}
